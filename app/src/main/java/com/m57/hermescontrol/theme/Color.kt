...
// ── StarMap memory visualizer tokens (issue #739) ────────────────────
val StarMapMemoryNode = Color(0xFF38BDF8)
val StarMapSkillNode = Color(0xFFA855F7)
val StarMapFactNode = Color(0xFFF59E0B)
val StarMapDefaultNode = Color(0xFF10B981)
val StarMapGlowOverlay = Color(0x337C5CFF)
val StarMapSpaceBackground = Color(0xFF090A0F)
val StarMapEdgeConnected = Color(0xFFAC93FF)
val StarMapEdgeDimmed = Color(0x1F79748E)
val StarMapEdgeDefault = Color(0x5579748E)
val StarMapNodeSelectedRing = Color(0xFFFFFFFF)
val StarMapGridDot = Color(0x15FFFFFF)
val StarMapNodeTextDimmed = Color(0x4DFFFFFF)
val StarMapNodeTextNormal = Color(0xE6FFFFFF)
