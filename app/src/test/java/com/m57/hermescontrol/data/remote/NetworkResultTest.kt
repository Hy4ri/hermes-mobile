...
class NetworkResultTest {
    ...
    fun testMapHttpError_knownCodes() {
        val codesAndExpectedMessages = mapOf(
    ...
    @Test
    fun testSafeApiCall_successWithBody() = runBlocking {
    ...
    @Test
    fun testSafeApiCall_successWithNullBody() = runBlocking {
    ...
    @Test
    fun testSafeApiCall_httpFailure_nonRetryable() = runBlocking {
        var callCount = 0
        val result = safeApiCall<String> {
            callCount++
    ...
    @Test
    fun testSafeApiCall_httpFailure_retryable_eventuallySucceeds() = runBlocking {
        var callCount = 0
        val result = safeApiCall<String> {
            callCount++
            if (callCount == 1) {
    ...
    @Test
    fun testSafeApiCall_httpFailure_retryable_exceedsMaxRetries() = runBlocking {
        var callCount = 0
        val result = safeApiCall<String>(retries = 2) {
            callCount++
    ...
    @Test
    fun testSafeApiCall_ioException_eventuallySucceeds() = runBlocking {
        var callCount = 0
        val result = safeApiCall<String> {
            callCount++
            if (callCount == 1) {
    ...
    @Test
    fun testSafeApiCall_ioException_exceedsMaxRetries() = runBlocking {
        var callCount = 0
        val result = safeApiCall<String>(retries = 2) {
            callCount++
    ...
    @Test
    fun testSafeApiCall_otherException() = runBlocking {
        var callCount = 0
        val result = safeApiCall<String> {
            callCount++
